...
// Hook into the 'init' action.
add_action( 'init', 'otavabooks\otava_toimittanut', 0 );
...
//Hook into the 'init' action
add_action('init', 'otavabooks\otava_sarja', 0);
...
//Hook into the 'init' action
add_action('init', 'otavabooks\otava_sidosasu', 0);
...
//Hook into the 'init' action
add_action('init', 'otavabooks\otava_julkaisija', 0);
...
//Hook into the 'init' action
add_action('init', 'otavabooks\otava_kuvittaja', 0);
...
//Hook into the 'init' action
add_action('init', 'otavabooks\otava_kaantaja', 0);
...
//Hook into the 'init' action
add_action( 'init', 'otavabooks\otava_kategoria', 0 );
